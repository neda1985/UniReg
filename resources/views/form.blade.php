...
بدهکار
                    ...
                    <div class="tab-pane with-bg" id="fwv-5">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="registerationShare"> نوع سهمیه خاص</label>
                                    <input class="form-control" name="registerationShare" id="registerationShare" value="{{$passShare}}"
                                           disabled/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <label class="control-label" for="shareRelation">
                                        نسبت با ایثارگر
                                    </label>
                                    <select id="shareRelation"
                                            class="form-control"
                                            data-validate="required"
                                            onchange="$(this).css('border-color','')">
                                        <option value="-"></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <label class="control-label" for="invalidPercent">
                                        درصد جانبازی
                                    </label>
                                    <input class="form-control" name="invalidPercent" id="invalidPercent"  onchange="$(this).css('border-color','')"/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <label class="control-label" for="invalidCode">
                                        کد ایثارگری
                                    </label>
                                    <input class="form-control" name="invalidCode"  onchange="$(this).css('border-color','')" id="invalidcode"/>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 50px;">
                            <div class="col-md-8">
                                <table class="table table-bordered table-striped" id="example-dropzone-filetable4"
                                       style="text-align: center;">
                                    <thead>
                                    <tr>
                                        <th width="40%" style="text-align: center;">عنوان فایل</th>
                            ...
                            <div class="col-md-4">
                                <table style="text-align: center;">
                                    <tr>
                                        <td style="width:20%;">
                                            <input type="text" id="imageformat-invalidCard" style="display:none;"/>
                                            <input type="hidden" id="invalidCard">

                                            <div id="invalidCardDropzone" class="droppable-area">
                                                <span style="font-size: 6; color: red;" class="glyphicon glyphicon-star"></span>
                                    ...
                                    <tr>
                                        <td style="width:20%;">
                                            <input type="text" id="imageformat-bonyadShahidImg" style="display:none;"/>
                                            <input type="hidden" id="bonyadShahidImg">

                                            <div id="bonyadShahidImgDropzone" class="droppable-area">
                                                <span style="font-size: 6; color: red;" class="glyphicon glyphicon-star"></span>

                                                تصویر معرفی نامه از بنیاد شهید
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                وفق مقررات بنیاد شهید و امور ایثارگران شهریه پذیرفته شدگانی که عضو خانواده های محترم
                                شاهد و ایثار بر اساس اعلام موسسه از طرف بنیاد شهید پرداخت میگردد. بدیهی است برقراری این
                                شرایط منوط به ایفاء بموقع تعهدات از سوی بنیاد شهید و امور ایثارگران میباشد.
                                قابل ذکر است تایید نهایی ثبت نام پس از احراز صحت کد ایثارگری از سوی بنیاد شهید منطقه
                                صورت میپذیرد.
                    ...
                    <ul class='pager wizard' style='margin-bottom: 0px;margin:0px'>
                        <li class='previous' style='float:right' id='previousli'>
                            <a href='#' id='previousstep'><i class='entypo-left-open' id="laststep"></i> مرحله قبلی</a>
                        </li>
                        <li class='next' style='float:left' id='nextli'>
                            <a href='#' id='nextstep'>مرحله بعدی <i class='entypo-right-open'></i></a>
                        </li>
                    </ul>
                    <div class="row tab-pane with-bg" id="fwv-6">
                        <div class="col-sm-4">
